...
const portfolioItems = [
  {
    title: '삼성전자 체육대회',
    category: '기업행사',
    image: import.meta.env.BASE_URL + 'portfolio/samsung/samsung-sports.jpg',
    size: 'large'
  },
  {
    title: '현대자동차 팀빌딩',
    category: '팀빌딩',
    image: import.meta.env.BASE_URL + 'portfolio/recreation/hyundai-teambuilding.jpg',
    size: 'medium'
  },
  {
    title: '서울초 가을운동회',
    category: '학교행사',
    image: import.meta.env.BASE_URL + 'portfolio/recreation/school-sports.jpg',
    size: 'small'
  },
  {
    title: '네이버 골든벨',
    category: '골든벨',
    image: import.meta.env.BASE_URL + 'portfolio/samsung/naver-goldenbell.jpg',
    size: 'small'
  },
]
    ...
    <div className="home">
      ...
      <section className="section services-section" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}images/service-wave-v2.png)` }}>
        <div className="container">
          ...
          >
            <img 
              src={`${import.meta.env.BASE_URL}services-special.png`} 
              alt="Special Event" 
              loading="lazy"
              style={{ 
                maxWidth: '100%', 
